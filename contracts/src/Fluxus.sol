 ...
 * @title Fluxus
 * @author @lukema95
 * @notice Fluxus contract for FLUXUSs, implements IFluxus interface
 */
contract Fluxus is BaseNFT, IFluxus {
    function initialize(
        string memory _name,
        ...
        __BaseNFT_init(_name, _symbol, _initialPrice, _maxSupply, _maxPrice, _creatorFeePercent, _feeVault, _priceContract, _creator, baseUri);
    }
