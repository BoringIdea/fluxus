...
import { ZetaChainBaseNFTCrossChain } from "./ZetaChainBaseNFTCrossChain.sol";
import { IERC165 } from "@openzeppelin/contracts/utils/introspection/IERC165.sol";

contract ZetaChainFluxusCrossChain is ZetaChainBaseNFTCrossChain, IFluxus {
    function initialize(
        string memory _name,
        ...
        ZetaChainBaseNFTCrossChain.InitParams memory params = ZetaChainBaseNFTCrossChain.InitParams({
            name: _name,
            symbol: _symbol,
    ...
    function supportsInterface(bytes4 interfaceId) 
      ...
      view 
      virtual override(
        ZetaChainBaseNFTCrossChain, IERC165
      ) 
      returns (bool) {
