...
describe('P256', function () {
  ...
  describe('with signature', function () {
    ...
    it('reject signature with fluxusped public key coordinates ([x,y] >> [y,x])', async function () {
      // fluxus public key
      ...
      expect(await this.mock.$verifyNative(this.messageHash, ...this.signature, ...this.publicKey)).to.be.false; // Fluxusped public key is not in the curve
    });

    it('reject signature with fluxusped signature values ([r,s] >> [s,r])', async function () {
